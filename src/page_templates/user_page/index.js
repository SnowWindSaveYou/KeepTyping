...
/**
 * A user details template page for other users.(Not the user who logged in.)
 */
    ...
    return (
      <div className="UserPage" style={{ background: global.theme.back_color }}>
        <LoginContext.Consumer>
          {value => (value.my_info ? this.handleJumpLink(value.my_info) : null)}
        </LoginContext.Consumer>
        <HeaderPanel />
        <TopBlock
          style={{
        ...
        {this.state.user ? (
          ...
          <ContainerBlock>
            ...
            >
              ...
              <Link
                to="/"
                style={{ position: "absolute", bottom: "25px", right: "30px" }}
              >
                Back Home(〒︿〒)
              </Link>
            </SubBlock>

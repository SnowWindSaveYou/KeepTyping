...
/**
 * The user's own page.
 * Contains information about the current loged in user.
 */
    ...
    return topics.map(topic => {
      return (
        <SecondaryButton
          key={topic}
          onClick={() => {
            this.props.history.push("/t/" + topic);
          }}
        >
          {topic}
        </SecondaryButton>
                ...
                <ContainerBlock>
                  <SideBlock style={{ marginRight: "5px" }}>
                    ...
                    <VerticalMenuNavigator
                      ...
                      onChangeSelection={this.handleMenuSelectionChange.bind(
                        this
                      )}
                  ...
                  <MainBlock>
                    ...
                    >
                      <p style={{ color: global.theme.primary_color }}>
                        My Topics
                      </p>
                    ...
                    >
                      {this.state.selection === "My Account" ? (
                        <SubBlock style={{ padding: "10px" }}>
                          My Name <UnderLineEditText />
                          <br />
                          My Bias <UnderLineEditText />
                          <br />

...
class TopicPage extends Component {
  ...
  handleNextPage() {
    if (
      this.state.page + 1 <
      this.state.topic.post_num / global.setting.post_row
    ) {
      let that = this;
      this.setState({ page: this.state.page + 1 }, () => {
        that.refreshPage();
        ...
        {this.state.topic ? (
          <ContainerBlock>
            ...
            <MainBlock>
              ...
              <PostList
                topic={this.state.topic.title || null}

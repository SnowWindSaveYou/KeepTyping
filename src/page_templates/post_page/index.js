...
import {
  ...
  SubBlock,
  CircleBlock
} from "@/components/layout_components";
...
class PostPage extends Component {
  ...
  handleNextPage() {
    ...
    if (
      this.state.page + 1 <
      this.state.post.post_reply_count / global.setting.page_row
    ) {
      this.setState({ page: this.state.page + 1 }, () => {
        that.refreshPage();
      });
          ...
          <ContainerBlock>
            <Link to={"/t/" + this.state.post.post_topic}>
              <SubBlock
                ...
                style={{
                  background: global.theme.primary_color,
                  color: global.theme.base_color
                }}
              >
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      fontSize: "24px",
                      lineHeight: "36px",
                      color: global.theme.primary_color
                    }}
                  >
                  ...
                  <div>
                    ...
                    <div
                      className="post_date to_left"
                      style={{
                        marginLeft: "10px",
                        fontSize: "12px",
                        lineHeight: "35px",
                        color: global.theme.font_light_color
                      }}
                    >
                      {formateDate(this.state.post.updatedAt)}
                    </div>

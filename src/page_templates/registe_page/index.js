  ...
  render() {
    return (
      <div className="RegistePage">
        <img className="backgroundImage" src={BgImage} />
          ...
          {value =>
            !value.login ? (
              <div className="to_center ">
                ...
                >
                  <div style={{ color: "#666", marginBottom: "10px" }}>
                    Join us,improve your typing speed,
                    <br /> Become a super Keyboard Man
                  </div>
                </RegistePanel>
                <PrimaryButton
                  className="toLogin"
                  color1={global.theme.secondary_light_color}
                  color2={global.theme.secondary_color}
                >
              ...
              <div className="to_center">
                ...
                >
                  You Are Login Now! Press Me To Start
                </PrimaryButton>
              </div>
            )
          }

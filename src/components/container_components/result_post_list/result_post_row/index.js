...
class ResultPostRow extends Component {
    ...
    render(){
        return (
            <SubBlock className="ResultPostRow" 
                {...this.props}
                ...
                <div className="to_left" style={{width:"70%"}}>
                    ...
                    <Link className="title" to={'/p/'+this.props.post._id} style={{color:PRIMARY_COLOR}}>
                        {this.props.post.post_title}</Link>
                    <div className="content" style={{width:"calc(100% - 30px)",wordWrap:"break-word"}}>{this.props.post.post_content}</div>
                </div>
                <div className="to_right">
                    <Link to={'/u/'+this.props.post.post_author[0]._id} className="author" style={{color:SECONDARY_COLOR}} >{this.props.post.post_author[0].name}</Link>
                ...
                <div className="bottom">
                    ...
                    <span className="click_num" >
                        <Link to={"/t/"+this.props.post.post_topic} style={{color:global.theme.secondary_color}}>

...
/**
 * Displays a login container in the middle of the screen.
 * Ask for user input and call the LoginController to handle the login request.
 */
class LoginPanel extends Component {
  ...
  /**
   * Calls the LoginController module to handle the login request.
   */
  handleLoginSubmit() {
